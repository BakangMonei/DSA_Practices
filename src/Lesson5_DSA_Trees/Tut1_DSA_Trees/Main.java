...
/* Trees
    ...
    - We have previously covered data structures like Arrays, Linked Lists, Stacks, and Queues.
    - These are all linear structures, which means that each element follows directly after another in a sequence.
